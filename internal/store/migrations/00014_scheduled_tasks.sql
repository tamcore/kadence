...
CREATE TABLE scheduled_tasks (
    ...
    delivery_policy      TEXT NOT NULL DEFAULT 'always' CHECK (delivery_policy IN ('always', 'on_change')),
    initial_run          TEXT NOT NULL DEFAULT 'wait' CHECK (initial_run IN ('wait', 'preview', 'baseline')),
    stop_condition       TEXT NOT NULL DEFAULT '',
    static_message       TEXT NOT NULL DEFAULT '',
